...
print("Reading Files...")
test_dataset = ["i am furious", "I am not happy", "I am extremely angry"]
...
print(f"Joy Prediction: {joy_preds}")
...
print(f"Sadness Prediction: {sadness_preds}")
...
print(f"Anger Prediction: {anger_preds}")
...
print(f"Love Prediction: {love_preds}")
...
print(f"Thankfulness Prediction: {thankfulness_preds}")
...
print(f"Fear Prediction: {fear_preds}")
...
# print(f"Surprise Prediction: {surprise_preds}")
